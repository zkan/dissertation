...
Figure \ref{fig:batch-example-behavior} shows examples of four common
...
%\begin{figure}[t]
%  \centering
%  \subfloat[]{\includegraphics[width=0.2\textwidth]{figures/example-behavior01.pdf}\label{fig:example-of-scene}}
%  \hspace{0.05in}
%  \subfloat[]{\includegraphics[width=0.2\textwidth]{figures/example-behavior02.pdf}}
%  \hspace{0.05in}
%  \subfloat[]{\includegraphics[width=0.2\textwidth]{figures/example-behavior03.pdf}}
%  \hspace{0.05in}
%  \subfloat[]{\includegraphics[width=0.2\textwidth]{figures/example-behavior04.pdf}}
...
The setting of the $z$-score threshold is important. With a $z$-threshold 
...
to those of \shortciteA{xiang08incremental}. \shortciteA{xiang08incremental}'s 
...
To classify a new observation sequence, given a new observation 
