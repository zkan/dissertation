...
\begin{figure}[t]
  \centering
  \begin{tabular}{ccc}
%    \includegraphics[scale=0.29]{figures/model-configuration01.png} &
%    \includegraphics[scale=0.29]{figures/model-configuration02.png} &
%    \includegraphics[scale=0.29]{figures/model-configuration03.png}\\
